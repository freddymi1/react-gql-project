                ...
                <div className='grid grid-cols-12'>
                  <div className='col-span-12 sm:col-span-2 md:col-span-2'>
                    <div className='float-left'>
                      <div className='w-16 h-16 rounded-full text-white bg-red-500 text-center ml-4'>
                        <div
                  ...
                  <div className='col-span-12 sm:col-span-10  md:col-span-10'>
                    <label className='mb-4 font-semibold text-gray-500 dark:text-gray-300'>
                      ...
                      a obtenu une badge en finissant avec succes:{' '}
                      {props.courseTitle}
                    </label>
                    <div className='block text-center m-auto sm:flex flex-row bg-white rounded-full py-4'>
                      {/* PIC */}
                      <div className='w-24 h-24 rounded-full bg-red-500 text-center'>
                        <div
...
export default RecentBadgeLesson;
