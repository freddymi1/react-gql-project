          ...
          <div className="w-full flex flex-row justify-center">
            <div className="w-1/3 text-center border-r-2 border-gray-50">
              <label className="space-x-1">
                <a href='#'>
                  <RiArrowUpSLine className='inline text-sm text-gray-50 font-bold' size='2em' />
                </a>
                <span className="inline text-sm text-gray-50 font-bold cursor-pointer">+104</span>
                <a href='#'>
                  <RiArrowDownSLine className='inline text-sm text-gray-50 font-bold' size='2em' />
                </a>
              </label>
            </div>
            <div className="w-1/3 text-center border-r-2 border-gray-50">
              <label className="space-x-1">
                ...
                <span className="text-white font-bold text-sm pt-6"
                  style={{ fontSize: "12px" }}
                >1004</span>
              </label>
            </div>
