            ...
            <div className="pb-16 border-b-2 border-gray-200">
                <div className=" flex flex-row space-x-4">
                    <div className="block text-center">
                        <h3 className="text-gray-500 font-bold cursor-pointer">2</h3>
                    ...
                    <div className="block">
                        <h3 className="text-gray-500 font-bold cursor-pointer hover:text-gray-600">Write a class C (stopwatch) that performs timing operations. Must have start (), stop () methods to start and stop the stopwatch</h3>
