        ...
        <div className="tab w-full overflow-auto">
          ...
          <div className="w-full overflow-hidden z-10" style={{ position: "absolute", top: "6.5%", bottom: "120px" }}>
            ...
            <div className={(showDescription ? "h-full opacity-100" : "h-0 overflow-hidden opacity-0") + " w-full"}>
              <DescriptionEditor language={ language   } description={ props.code.description } setDescription={ setDescription } setPrivacy={ setPrivacy } saveWebCode={ saveWebCode }  privacy={ privacy } />
            </div>
  
            <div className={(showCode ? "h-full opacity-100" : "h-0 overflow-hidden opacity-0") + " w-full"}>
              <CodeEditor language={ language } lineOfCode={JSON.parse(props.code.content)} handleCodeChange={handleCodeChange} setPrivacy={ setPrivacy }  privacy={ privacy }  saveWebCode={ saveWebCode } />
            </div>
