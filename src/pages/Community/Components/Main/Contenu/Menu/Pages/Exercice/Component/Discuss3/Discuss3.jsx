                ...
                <div className=" flex flex-wrap space-x-4">
                    <div className="block text-center">
                        <div className="flex">
                            ...
                            <span className="inline text-sm text-gray-500 font-bold cursor-pointer">904</span>
                            <a href='#'>
                    ...
                    {/* <div className="block text-center">
                        ...
                        <h3 className="text-sm text-gray-500 font-bold cursor-pointer">809</h3>

                        <span className="text-gray-400 text-md">Answers</span>
                    </div> */}
                    <div className="block">
                        <h3 className="text-gray-500 font-bold cursor-pointer hover:text-gray-600">Let's stay safe together, people! 👮</h3>
