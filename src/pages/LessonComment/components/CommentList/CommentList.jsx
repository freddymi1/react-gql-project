...
const CommentList = (props) => {
  ...
  //     active === 'active'
  //       ? '0px'
  //       : `${content.current.childElementCount * 120 + 56 + 180}px`
  //   );
  // }, []);
  ...
  function toggleAccordion() {
    ...
    setHeight(
      active === 'active'
        ? '0px'
        : `${(countCommentResp + 5) * (130 + countCommentResp) + 180 + 56}px`
    );
    setRotate(active === 'active' ? 'reponse_icon' : 'reponse_icon rotate');
    // console.log(countCommentResp * (130 + countCommentResp) + 180 + 56);
    // console.log(content);
  }
    ...
    <div className="w-full bg-white rounded-lg p-3  justify-center  md:items-start shadow-md mb-4 mx-auto clear-right">
      <div className="w-full flex flex-row justify-center mr-2 ">
        ...
        <div className="w-full">
          <h3 className="text-purple-600 font-semibold text-base text-left md:text-sm mb-2">
            @{props.comment.student.name}
          </h3>
          <p className="text-gray-600 text-base text-left md:text-sm">
